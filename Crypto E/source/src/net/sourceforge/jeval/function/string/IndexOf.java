    ...
    implements Function
{
    ...
    public FunctionResult a(Evaluator evaluator, String s)
    {
        ...
        try
        {
            integer = new Integer(FunctionHelper.a((String)arraylist.get(0), evaluator.a()).indexOf(FunctionHelper.a((String)arraylist.get(1), evaluator.a()), ((Integer)arraylist.get(2)).intValue()));
        }
