...
_L3:
        ...
        if (!TextUtils.isEmpty(charsequence) && charsequence.toString().toLowerCase().contains(s))
        {
            list.add(createAccessibilityNodeInfo(2));
            return;
        }
        CharSequence charsequence1 = SnapchatTimePicker.a(a).getText();
        if (!TextUtils.isEmpty(charsequence1) && charsequence1.toString().toLowerCase().contains(s))
        {
            list.add(createAccessibilityNodeInfo(2));
            return;
        }
...
_L5:
    ...
    private String d()
    {
        int i = -1 + SnapchatTimePicker.i(a);
        if (SnapchatTimePicker.j(a))
        {
            i = SnapchatTimePicker.c(a, i);
        }
        if (i >= SnapchatTimePicker.k(a))
        {
            if (SnapchatTimePicker.l(a) == null)
            {
                return SnapchatTimePicker.d(a, i);
            } else
            {
                return SnapchatTimePicker.l(a)[i - SnapchatTimePicker.k(a)];
            }
        } else
        {
            return null;
...
_L4:
        ...
        {
        default:
            return SnapchatTimePicker.a(a).performAccessibilityAction(j, bundle);
