        ...
        while (j2 < i2) 
        {
            ...
            } else
            {
                ...
                if (layoutparams.slideable)
                {
                    ...
                    int i5 = Math.min(j1, i1 - k1 - mOverhangSize) - k2 - l4;
                    mSlideRange = i5;
                    int j5;
                    boolean flag2;
                    int k5;
                    if (flag1)
                    {
                        j5 = layoutparams.rightMargin;
                    } else
                    {
                        j5 = layoutparams.leftMargin;
                    }
                    if (i5 + (k2 + j5) + i3 / 2 > i1 - k1)
                    {
                        flag2 = true;
                    } else
                    {
                    ...
                    k5 = (int)((float)i5 * mSlideOffset);
                    j3 = k2 + (j5 + k5);
                    mSlideOffset = (float)k5 / (float)mSlideRange;
                    k3 = 0;
                } else
