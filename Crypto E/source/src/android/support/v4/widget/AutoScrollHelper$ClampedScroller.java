...
static class mDeltaY
{
    ...
    private float getValueAt(long l)
    {
        ...
        {
            return 0.5F * AutoScrollHelper.access$900((float)(l - mStartTime) / (float)mRampUpDuration, 0.0F, 1.0F);
        } else
        {
            long l1 = l - mStopTime;
            return (1.0F - mStopValue) + mStopValue * AutoScrollHelper.access$900((float)l1 / (float)mEffectiveRampDown, 0.0F, 1.0F);
        }
    }
