...
public static final class mGetStatusCodeMethod
{
    ...
    {
        android.media.nnectingWorkaround nnectingworkaround;
        nnectingworkaround = (android.media.nnectingWorkaround)obj;
        ...
        int i;
        int j;
        i = ((Integer)mGetStatusCodeMethod.invoke(nnectingworkaround, new Object[0])).intValue();
        j = mStatusConnecting;
        return i == j;
