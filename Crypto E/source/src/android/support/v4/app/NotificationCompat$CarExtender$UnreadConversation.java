...
public static class mLatestTimestamp extends mLatestTimestamp
{
    public static class Builder
    {
        ...
        public NotificationCompat.CarExtender.UnreadConversation build()
        {
            ...
            as1[0] = mParticipant;
            return new NotificationCompat.CarExtender.UnreadConversation(as, mRemoteInput, mReplyPendingIntent, mReadPendingIntent, as1, mLatestTimestamp);
        }
    ...
    volatile mRemoteInput getRemoteInput()
    {
