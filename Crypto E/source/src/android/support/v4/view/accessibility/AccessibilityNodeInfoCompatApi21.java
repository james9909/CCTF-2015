...
class AccessibilityNodeInfoCompatApi21
{
    ...
    {
        android.view.accessibility.AccessibilityNodeInfo.AccessibilityAction accessibilityaction = new android.view.accessibility.AccessibilityNodeInfo.AccessibilityAction(i, charsequence);
        ((AccessibilityNodeInfo)obj).addAction(accessibilityaction);
    }
