...
_L1:
        ...
        k7 = j2 + k5;
_L5:
        mCurrText.layout(k3, j7, l3, j7 + mCurrText.getMeasuredHeight());
        l7 = Math.min(l1, k3 - mScaledTextSpacing - j);
        mPrevText.layout(l7, i7, j + l7, i7 + mPrevText.getMeasuredHeight());
        i8 = Math.max(j1 - i2 - l, l3 + mScaledTextSpacing);
        mNextText.layout(i8, k7, i8 + l, k7 + mNextText.getMeasuredHeight());
        mLastKnownPositionOffset = f;
        mUpdatingPositions = false;
        return;
_L2:
        int j8 = (k1 - j2 - k2 - k6) / 2;
        i7 = j8 + i5;
        j7 = j5 + j8;
        k7 = j8 + k5;
