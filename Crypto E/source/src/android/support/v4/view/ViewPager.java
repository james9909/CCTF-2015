...
public class ViewPager extends ViewGroup
{
    ...
    private void calculatePageOffsets(ItemInfo iteminfo, int i, ItemInfo iteminfo1)
    {
        ...
        if (iteminfo1 != null)
        {
            ...
            {
                float f8 = f + (iteminfo1.offset + iteminfo1.widthFactor);
                int l3 = i3 + 1;
                for (int i4 = 0; l3 <= iteminfo.position && i4 < mItems.size(); l3++)
                {
                    ItemInfo iteminfo5;
                    for (iteminfo5 = (ItemInfo)mItems.get(i4); l3 > iteminfo5.position && i4 < -1 + mItems.size(); iteminfo5 = (ItemInfo)mItems.get(i4))
                    {
                        i4++;
                    }

                    for (; l3 < iteminfo5.position; l3++)
                    {
                        f8 += f + mAdapter.getPageWidth(l3);
                    }

                    iteminfo5.offset = f8;
                    f8 += f + iteminfo5.widthFactor;
                }
            ...
            if (i3 > iteminfo.position)
            {
                ...
                float f7 = iteminfo1.offset;
                for (int k3 = i3 - 1; k3 >= iteminfo.position && j3 >= 0; k3--)
                {
                    ItemInfo iteminfo4;
                    for (iteminfo4 = (ItemInfo)mItems.get(j3); k3 < iteminfo4.position && j3 > 0; iteminfo4 = (ItemInfo)mItems.get(j3))
                    {
                        j3--;
                    }

                    for (; k3 > iteminfo4.position; k3--)
                    {
                        f7 -= f + mAdapter.getPageWidth(k3);
                    }

                    f7 -= f + iteminfo4.widthFactor;
                    iteminfo4.offset = f7;
                }
        ...
        mLastOffset = f3;
        int k2;
        for (int j1 = i - 1; j1 >= 0; j1 = k2)
        {
            ItemInfo iteminfo3 = (ItemInfo)mItems.get(j1);
            float f6 = f1;
            int l2;
            for (; i1 > iteminfo3.position; i1 = l2)
            {
                PagerAdapter pageradapter1 = mAdapter;
                l2 = i1 - 1;
                f6 -= f + pageradapter1.getPageWidth(i1);
            }

            f1 = f6 - (f + iteminfo3.widthFactor);
            iteminfo3.offset = f1;
        ...
        int i2;
        for (int l1 = i + 1; l1 < l; l1 = i2)
        {
            ItemInfo iteminfo2 = (ItemInfo)mItems.get(l1);
            float f5 = f4;
            int j2;
            for (; k1 < iteminfo2.position; k1 = j2)
            {
                PagerAdapter pageradapter = mAdapter;
                j2 = k1 + 1;
                f5 += f + pageradapter.getPageWidth(k1);
            }

            if (iteminfo2.position == j - 1)
            {
                mLastOffset = (f5 + iteminfo2.widthFactor) - 1.0F;
            }
            iteminfo2.offset = f5;
            f4 = f5 + (f + iteminfo2.widthFactor);
            i2 = l1 + 1;
            k1++;
        }
...
_L7:
    ...
    void dataSetChanged()
    {
        ...
        while (l < mItems.size()) 
        {
            ...
            int k1 = mAdapter.getItemPosition(iteminfo.object);
            int l1;
            boolean flag3;
            int i2;
            boolean flag4;
            ...
            if (k1 == -2)
            {
                ...
                {
                    int l2 = Math.max(0, Math.min(mCurItem, i - 1));
                    l1 = k2;
                    flag3 = flag1;
                    i2 = l2;
                    flag4 = true;
...
_L1:
        ...
        k = mItems.size();
        int l = iteminfo.position;
        i1 = ((ItemInfo)mItems.get(k - 1)).position;
        j1 = 0;
        k1 = l;
_L6:
        if (k1 >= i1) goto _L2; else goto _L3
_L3:
        ArrayList arraylist;
...
_L3:
        ...
        k3 = i5;
_L8:
        int l3 = (l2 + j1) - view1.getLeft();
        if (l3 != 0)
        {
            view1.offsetLeftAndRight(l3);
        }
          goto _L7
_L5:
        int k4 = k1 + view1.getWidth();
        int l4 = k1;
        k3 = l1;
        j3 = k4;
        l2 = l4;
...
_L4:
        ...
        int i3 = l1 + view1.getMeasuredWidth();
        j3 = k1;
        k3 = i3;
          goto _L8
        if (mOnPageChangeListener != null)
...
_L8:
    ...
    void populate(int i)
    {
        ...
        if (mCurItem != i)
        {
            ...
            iteminfo14 = infoForPosition(mCurItem);
            mCurItem = i;
            iteminfo = iteminfo14;
            byte0 = byte1;
        } else
...
_L14:
        if (iteminfo6 != null) goto _L16; else goto _L13
_L13:
        f2 = iteminfo2.widthFactor;
        i4 = k3 + 1;
        if (f2 >= 2.0F) goto _L18; else goto _L17
_L17:
        ItemInfo iteminfo7;
        float f3;
        if (i4 < mItems.size())
        ...
        l4 = j4;
_L26:
        if (l4 >= l) goto _L18; else goto _L19
_L19:
        if (f2 < f3 || l4 <= i1) goto _L21; else goto _L20
_L20:
        if (iteminfo8 != null) goto _L22; else goto _L18
_L18:
...
_L15:
        ...
        } else
        {
          ...
          goto _L25
_L22:
        if (l4 == iteminfo8.position && !iteminfo8.scrolling)
        {
            mItems.remove(k4);
            mAdapter.destroyItem(this, l4, iteminfo8.object);
            float f6;
            ItemInfo iteminfo13;
            float f9;
            if (k4 < mItems.size())
        ...
        {
            float f8 = f2;
            iteminfo11 = iteminfo8;
            f5 = f8;
        }
        l4++;
        f6 = f5;
        iteminfo8 = iteminfo11;
        f2 = f6;
          goto _L26
_L21:
        if (iteminfo8 != null && l4 == iteminfo8.position)
        {
            float f7 = f2 + iteminfo8.widthFactor;
            ItemInfo iteminfo12;
            if (++k4 < mItems.size())
            {
                iteminfo12 = (ItemInfo)mItems.get(k4);
            } else
            {
                iteminfo12 = null;
            }
        ...
        {
            ItemInfo iteminfo9 = addNewItem(l4, k4);
            k4++;
            float f4 = f2 + iteminfo9.widthFactor;
            ItemInfo iteminfo10;
            if (k4 < mItems.size())
            {
                iteminfo10 = (ItemInfo)mItems.get(k4);
            } else
            {
                iteminfo10 = null;
            }
            iteminfo11 = iteminfo10;
            f5 = f4;
        }
...
_L27:
        ...
        if (iteminfo3 != null && iteminfo3.position == mCurItem) goto _L4; else goto _L28
_L28:
        j2 = 0;
_L31:
        if (j2 >= getChildCount()) goto _L4; else goto _L29
_L29:
        view1 = getChildAt(j2);
        iteminfo4 = infoForChild(view1);
        if (iteminfo4 != null && iteminfo4.position == mCurItem && view1.requestFocus(byte0)) goto _L4; else goto _L30
_L30:
        j2++;
          goto _L31
        iteminfo1 = null;
