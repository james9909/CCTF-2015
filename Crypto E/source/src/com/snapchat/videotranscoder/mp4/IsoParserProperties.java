...
public class IsoParserProperties extends Properties
{

    private static IsoParserProperties a;
    ...
    public static IsoParserProperties a()
    {
        if (a == null)
        {
            a = new IsoParserProperties();
        }
        return a;
    }
    ...
    private void b()
    {
        ...
        setProperty("\251nam", "com.googlecode.mp4parser.boxes.apple.AppleNameBox");
        setProperty("\251ART", "com.googlecode.mp4parser.boxes.apple.AppleArtistBox");
        setProperty("aART", "com.googlecode.mp4parser.boxes.apple.AppleArtist2Box");
        setProperty("\251alb", "com.googlecode.mp4parser.boxes.apple.AppleAlbumBox");
        setProperty("\251gen", "com.googlecode.mp4parser.boxes.apple.AppleGenreBox");
        setProperty("gnre", "com.googlecode.mp4parser.boxes.apple.AppleGenreIDBox");
        setProperty("\251day", "com.googlecode.mp4parser.boxes.apple.AppleRecordingYear2Box");
        ...
        setProperty("\251cmt", "com.googlecode.mp4parser.boxes.apple.AppleCommentBox");
        setProperty("tmpo", "com.googlecode.mp4parser.boxes.apple.AppleTempoBox");
        setProperty("\251too", "com.googlecode.mp4parser.boxes.apple.AppleEncoderBox");
        setProperty("\251wrt", "com.googlecode.mp4parser.boxes.apple.AppleTrackAuthorBox");
        setProperty("\251grp", "com.googlecode.mp4parser.boxes.apple.AppleGroupingBox");
        setProperty(" covr", "com.googlecode.mp4parser.boxes.apple.AppleCoverBox");
        setProperty("\251lyr", "com.googlecode.mp4parser.boxes.apple.AppleLyricsBox");
