...
public final class CardInputError extends Enum
{
    ...
    static 
    {
        ...
        CardInputError acardinputerror[] = new CardInputError[10];
        acardinputerror[0] = UNKNOWN;
        acardinputerror[1] = TOO_MANY_ATTEMPTS;
        acardinputerror[2] = BLOCKED_CARD;
        acardinputerror[3] = CARD_TYPE_UNSUPPORTED;
        acardinputerror[4] = INVALID_CARD_NUMBER;
        acardinputerror[5] = INVALID_EXPIRATION;
        acardinputerror[6] = INVALID_SECURITY_CODE;
        acardinputerror[7] = INVALID_POSTAL_CODE;
        acardinputerror[8] = UNSUPPORTED_REGION;
        acardinputerror[9] = NETWORK_FAILURE;
        $VALUES = acardinputerror;
    }
}
