...
public final class CardBrand extends Enum
{
    ...
    static 
    {
        ...
        CardBrand acardbrand[] = new CardBrand[7];
        acardbrand[0] = UNKNOWN;
        acardbrand[1] = VISA;
        acardbrand[2] = MASTER_CARD;
        acardbrand[3] = AMERICAN_EXPRESS;
        acardbrand[4] = DISCOVER;
        acardbrand[5] = DISCOVER_DINERS;
        acardbrand[6] = JCB;
        $VALUES = acardbrand;
    }
}
