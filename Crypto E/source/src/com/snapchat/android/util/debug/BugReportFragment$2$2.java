    ...
    implements android.content.kListener
{
    ...
    public void onClick(DialogInterface dialoginterface, int i)
    {
        ...
        {
            BugReportFragment.b(a.a, true);
            BugReportFragment.e(a.a).setVisibility(8);
        }
    }
...
/* anonymous class */
        ...
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            (new android.app.AlertDialog.Builder(BugReportFragment.c(b))).setTitle("Included Screenshot").setView(imageview).setPositiveButton("Include", new BugReportFragment._cls2._cls2(this)).setNegativeButton("Remove", new BugReportFragment._cls2._cls1()).show();
        }
        ...
        // Unreferenced inner class com/snapchat/android/util/debug/BugReportFragment$2$1

/* anonymous class */
        class BugReportFragment._cls2._cls1
