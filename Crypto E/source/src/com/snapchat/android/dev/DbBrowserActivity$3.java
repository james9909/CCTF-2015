    ...
    implements android.widget.ickListener
{
    ...
    public void onItemClick(AdapterView adapterview, View view, int i, long l)
    {
        ...
        if (obj instanceof com.snapchat.android.database.vtable.aseVirtualTable)
        {
            com.snapchat.android.database.vtable.aseVirtualTable asevirtualtable = (com.snapchat.android.database.vtable.aseVirtualTable)obj;
            DbBrowserActivity.a(b, asevirtualtable);
            b.b();
        }
