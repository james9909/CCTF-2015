    ...
    implements Schema
{
    ...
    {
        return (f)Enum.valueOf(com/snapchat/android/database/table/ChatsReceivedInLastHourTable$ChatReceivedViaTcpSchema, s);
    }
    ...
    static 
    {
        ...
        c = new <init>("SENDER_USERNAME", 2, 2, "sender_username", DataType.a);
        g ag[] = new <init>[3];
        ag[0] = a;
        ag[1] = b;
        ag[2] = c;
