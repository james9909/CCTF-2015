...
class b
    implements com.snapchat.android.api2.cash.square.k.UpdateSuccessListener
{
    ...
    public void a()
    {
        ThreadUtils.a(new Runnable() {
            ...
            final CashSettingsFragment._cls9 a;
            ...
            {
                a = CashSettingsFragment._cls9.this;
                super();
            }
        });
        UserPrefs.q(a);
...
_L4:
    ...
    _cls1.a(CashSettingsFragment cashsettingsfragment, boolean flag, SecurityCodeFragment securitycodefragment)
    {
