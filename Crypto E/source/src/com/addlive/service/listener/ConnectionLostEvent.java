...
public class ConnectionLostEvent
{
    ...
    {
        return (new StringBuilder()).append("ConnectionLostEvent{scopeId=").append(scopeId).append(", errCode=").append(errCode).append(", errMessage=").append(errMessage).append("}").toString();
    }
}
