...
public class DeviceListChangedEvent
{
    ...
    {
        return (new StringBuilder()).append("DeviceListChangedEvent{audioIn=").append(audioIn).append(", audioOut=").append(audioOut).append(", videoIn=").append(videoIn).append("}").toString();
    }
}
