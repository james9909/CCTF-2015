...
public class MessageEvent
{
    ...
    {
        return (new StringBuilder()).append("MessageEvent{data.length=").append(data.length).append(", srcUserId=").append(srcUserId).append(", scopeId=").append(scopeId).append("}").toString();
    }
}
