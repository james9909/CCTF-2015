...
public class MediaStatsEvent
{
    ...
    {
        return (new StringBuilder()).append("MediaStatsEvent{scopeId=").append(scopeId).append(", mediaType=").append(mediaType).append(", remoteUserId=").append(remoteUserId).append(", stats=").append(stats).append("}").toString();
    }
}
