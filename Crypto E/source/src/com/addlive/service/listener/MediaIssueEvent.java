...
public class MediaIssueEvent
{
    ...
    {
        return (new StringBuilder()).append("MediaIssueEvent{scopeId=").append(scopeId).append(", mediaType=").append(mediaType).append(", userId=").append(userId).append(", isActive=").append(isActive).append(", issueCode=").append(issueCode).append(", message=").append(message).append("}").toString();
    }
}
