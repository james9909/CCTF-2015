...
public class MediaConnTypeChangedEvent
{
    ...
    {
        return (new StringBuilder()).append("MediaConnTypeChangedEvent{scopeId=").append(scopeId).append(", mediaType=").append(mediaType).append(", connectionType=").append(connectionType).append("}").toString();
    }
}
