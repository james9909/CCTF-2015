...
public final class VideoCaptureDevice extends Enum
{
    ...
    static 
    {
        ...
        VideoCaptureDevice avideocapturedevice[] = new VideoCaptureDevice[2];
        avideocapturedevice[0] = FRONT_CAMERA;
        avideocapturedevice[1] = BACK_CAMERA;
        $VALUES = avideocapturedevice;
    }
}
