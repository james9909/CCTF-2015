    ...
    implements Responder
{
    ...
    {
        Log.e("AddLive_SDK", (new StringBuilder()).append("Got an error while calling method: ").append(method).append(" cause: ").append(s).append("(").append(i).append(")").toString());
    }

    public void resultHandler(Object obj)
    {
        Log.d("AddLive_SDK", (new StringBuilder()).append("Got successful result of method call: ").append(method).toString());
    }
}
