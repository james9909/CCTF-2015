...
public class VideoStreamDescriptor
{
    ...
    {
        return (new StringBuilder()).append("VideoStreamDescriptor{maxWidth=").append(maxWidth).append(", maxHeight=").append(maxHeight).append(", maxFps=").append(maxFps).append(", useAdaptation=").append(useAdaptation).append("}").toString();
    }
}
