...
public final class MediaIssueCode extends Enum
{
    ...
    static 
    {
        ...
        MediaIssueCode amediaissuecode[] = new MediaIssueCode[5];
        amediaissuecode[0] = CONNECTION_FROZEN;
        amediaissuecode[1] = CPU_LOAD_HIGH;
        amediaissuecode[2] = EXTERNAL_CPU_LOAD_HIGH;
        amediaissuecode[3] = NETWORK_PROBLEM;
        amediaissuecode[4] = UNKNOWN;
        $VALUES = amediaissuecode;
    }
}
