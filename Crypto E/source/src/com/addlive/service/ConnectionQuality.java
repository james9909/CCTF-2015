...
public final class ConnectionQuality extends Enum
{
    ...
    static 
    {
        ...
        ConnectionQuality aconnectionquality[] = new ConnectionQuality[4];
        aconnectionquality[0] = FINE;
        aconnectionquality[1] = AVERAGE;
        aconnectionquality[2] = BAD;
        aconnectionquality[3] = UNKNOWN;
        $VALUES = aconnectionquality;
    }
}
