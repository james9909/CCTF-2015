...
public final class ConnectionType extends Enum
{
    ...
    public static ConnectionType fromString(String s)
    {
        ...
        int i = aconnectiontype.length;
        for (int j = 0; j < i; j++)
        {
            ConnectionType connectiontype = aconnectiontype[j];
    ...
    static 
    {
        ...
        ConnectionType aconnectiontype[] = new ConnectionType[4];
        aconnectiontype[0] = NOT_CONNECTED;
        aconnectiontype[1] = UDP_RELAY;
        aconnectiontype[2] = UDP_P2P;
        aconnectiontype[3] = TCP_RELAY;
