...
public class ServiceResponse
{
    ...
    public ServiceResponse(String s)
    {
        ...
        status = false;
        errorCode = 1006;
        errorMessage = (new StringBuilder()).append("Failed to parse AddLiveService response. This is caused by an SDK error, please report it to AddLive. Faulty input:").append(s).toString();
    }
