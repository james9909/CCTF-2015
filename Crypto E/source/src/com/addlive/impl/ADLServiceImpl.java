    ...
    implements AddLiveService
{
    ...
    class DevicesResultAdapter extends BaseResultAdapter
    {
        ...
        void handleSuccess(Object obj)
        {
            ...
            {
                String s;
                for (; iterator.hasNext(); linkedlist.add(new Device(s, jsonobject.getString(s))))
                {
    ...
    class MediaConnResultAdapter extends BaseResultAdapter
    {
        ...
        void handleSuccess(Object obj)
        {
            if (responder != null)
            {
                ...
                nativePlatform.getActiveConnections().put(scopeId, adlmediaconnectionimpl);
    ...
    class NetworkTestResultAdapter extends BaseResultAdapter
    {
        ...
        void handleSuccess(Object obj)
        {
            ...
            } else
            {
                ...
                responder.resultHandler(ConnectionQuality._fromInt(integer.intValue()));
                return;
            }
        }
    ...
    public void cancelDeferredDisconnect(Responder responder, String s)
    {
        Log.v("AddLive_SDK", (new StringBuilder()).append("Calling method cancelDeferredDisconnect(").append(s).append(")").toString());
        ServiceRequest servicerequest = new ServiceRequest("cancelDeferredDisconnect");
        servicerequest.getParams().put(s);
        nativePlatform.invoke(new UpdateAudioSettingsResultAdapter(responder), servicerequest);
    }

    public void connect(Responder responder, ConnectionDescriptor connectiondescriptor)
    {
        Log.v("AddLive_SDK", (new StringBuilder()).append("Calling method connect(").append(connectiondescriptor).append(")").toString());
        ServiceRequest servicerequest = new ServiceRequest("connect");
        String s;
        try
        {
            servicerequest.getParams().put(connectiondescriptor.toJSON());
            s = connectiondescriptor.getScopeId();
        }
        catch (JSONException jsonexception)
        {
            responder.errHandler(1006, (new StringBuilder()).append("Failed to serialise the connection descriptor due to: ").append(jsonexception).toString());
            return;
        }
        catch (ArrayIndexOutOfBoundsException arrayindexoutofboundsexception)
        {
            responder.errHandler(1006, (new StringBuilder()).append("Failed to serialise the connection descriptor due to: ").append(arrayindexoutofboundsexception).toString());
            return;
        }
        if (s != null)
        {
    ...
    public void deferredDisconnect(Responder responder, String s, int i)
    {
        Log.v("AddLive_SDK", (new StringBuilder()).append("Calling method deferredDisconnect(").append(s).append(")").toString());
    ...
    {
        Log.v("AddLive_SDK", (new StringBuilder()).append("Calling method disconnect(").append(s).append(")").toString());
    ...
    {
        Log.v("AddLive_SDK", (new StringBuilder()).append("Calling method getProperty(").append(s).append(")").toString());
    ...
    public void injectFrame(byte abyte0[], com.addlive.service.AddLiveService.VideoFrameMetadata videoframemetadata)
    {
        ...
        int i = ((WindowManager)appContext.getSystemService("window")).getDefaultDisplay().getRotation();
        android.hardware.Camera.CameraInfo camerainfo = videoframemetadata.getInfo();
        int j;
        if (camerainfo.facing == 1)
        {
            j = (i + camerainfo.orientation / 90) % 4;
        } else
        {
            j = (4 + (camerainfo.orientation / 90 - i)) % 4;
        }
        ((ADLNativeWrapperImpl)nativePlatform).injectFrame(abyte0, videoframemetadata.getWidth(), videoframemetadata.getHeight(), abyte0.length, 17, j, System.currentTimeMillis());
    }

    public void monitorSpeechActivity(Responder responder, String s, boolean flag)
    {
        Log.v("AddLive_SDK", (new StringBuilder()).append("Calling method monitorSpeechActivity(").append(s).append(", ").append(flag).append(")").toString());
    ...
    {
        Log.v("AddLive_SDK", (new StringBuilder()).append("Calling method publish(").append(s).append(",").append(mediatype).append(")").toString());
    ...
    {
        Log.v("AddLive_SDK", (new StringBuilder()).append("Calling method reconfigureVideo(").append(s).append(", ").append(videostreamdescriptor).append(")").toString());
        ...
        {
            responder.errHandler(1006, (new StringBuilder()).append("Failed to serialise the video stream descriptor due to: ").append(jsonexception).toString());
        }
        nativePlatform.invoke(new VoidResultAdapter(responder), servicerequest);
    }
    ...
    {
        Log.v("AddLive_SDK", (new StringBuilder()).append("Calling method sendMessage(").append(s).append(", size = ").append(s1.length()).append(", ").append(long1).append(")").toString());
    ...
    {
        Log.v("AddLive_SDK", (new StringBuilder()).append("Calling method sendMessage(").append(s).append(", size = ").append(abyte0.length).append(", ").append(long1).append(")").toString());
    ...
    {
        Log.v("AddLive_SDK", (new StringBuilder()).append("Calling method setAllowedSenders(").append(s).append(")").toString());
        ServiceRequest servicerequest = new ServiceRequest("setAllowedSenders");
        servicerequest.getParams().put(s);
        servicerequest.getParams().put(mediatype);
        JSONArray jsonarray = new JSONArray();
        for (Iterator iterator = list.iterator(); iterator.hasNext(); jsonarray.put((Long)iterator.next())) { }
    ...
    {
        Log.v("AddLive_SDK", (new StringBuilder()).append("Calling method setApplicationId(").append(long1).append(")").toString());
...
_L4:
    ...
    public void setAudioOutputDevice(Responder responder, String s)
    {
        ...
        {
            responder.errHandler(1002, illegalargumentexception.getMessage());
        }
    }

    public void setProperty(Responder responder, String s, String s1)
    {
        Log.v("AddLive_SDK", (new StringBuilder()).append("Calling method setProperty(").append(s).append(", ").append(s1).append(")").toString());
    ...
    {
        Log.v("AddLive_SDK", (new StringBuilder()).append("Calling method setProxyServer(").append(s).append(", ").append(s1).append(", ").append(i).append(")").toString());
    ...
    {
        Log.v("AddLive_SDK", (new StringBuilder()).append("Calling method setVideoCaptureDevice(").append(s).append(")").toString());
    ...
    {
        String s1 = (new File(appContext.getCacheDir(), s)).getAbsolutePath();
    ...
    {
        Log.v("AddLive_SDK", (new StringBuilder()).append("Calling method startMeasuringStats(").append(s).append(", ").append(i).append(")").toString());
    ...
    {
        Log.v("AddLive_SDK", (new StringBuilder()).append("Calling method stopMeasuringStats(").append(s).append(")").toString());
    ...
    {
        Log.v("AddLive_SDK", (new StringBuilder()).append("Calling method unpublish(").append(s).append(",").append(mediatype).append(")").toString());
