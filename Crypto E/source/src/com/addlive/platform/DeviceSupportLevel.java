...
public final class DeviceSupportLevel extends Enum
{
    ...
    static 
    {
        ...
        DeviceSupportLevel adevicesupportlevel[] = new DeviceSupportLevel[4];
        adevicesupportlevel[0] = FULLY_SUPPORTED;
        adevicesupportlevel[1] = AUDIO_ONLY;
        adevicesupportlevel[2] = NOT_SUPPORTED;
        adevicesupportlevel[3] = NOT_FUNCTIONAL;
        $VALUES = adevicesupportlevel;
    }
}
