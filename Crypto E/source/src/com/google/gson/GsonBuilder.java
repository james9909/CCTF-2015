...
_L1:
        DefaultDateTypeAdapter defaultdatetypeadapter = new DefaultDateTypeAdapter(s);
_L6:
        list.add(TreeTypeAdapter.a(TypeToken.get(java/util/Date), defaultdatetypeadapter));
        list.add(TreeTypeAdapter.a(TypeToken.get(java/sql/Timestamp), defaultdatetypeadapter));
        list.add(TreeTypeAdapter.a(TypeToken.get(java/sql/Date), defaultdatetypeadapter));
_L4:
        return;
_L2:
        if (i1 == 2 || j1 == 2) goto _L4; else goto _L3
_L3:
        defaultdatetypeadapter = new DefaultDateTypeAdapter(i1, j1);
...
_L5:
    ...
    public GsonBuilder registerTypeHierarchyAdapter(Class class1, Object obj)
    {
        ...
        {
            f.add(0, TreeTypeAdapter.a(class1, obj));
        }
        if (obj instanceof TypeAdapter)
        {
