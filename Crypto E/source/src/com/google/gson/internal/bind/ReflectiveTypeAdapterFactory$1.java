...
class c extends undField
{
    ...
    undField(ReflectiveTypeAdapterFactory reflectivetypeadapterfactory, String s, boolean flag, boolean flag1, Gson gson, TypeToken typetoken, Field field, 
            boolean flag2)
    {
