    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        boolean flag;
        b.bc("LoadBitmapFromDiskRunnable can't be executed in the main thread");
        parcelfiledescriptor = SW;
        bitmap = null;
        flag = false;
        if (parcelfiledescriptor == null) goto _L2; else goto _L1
_L1:
        android.graphics.Bitmap bitmap1 = BitmapFactory.decodeFileDescriptor(SW.getFileDescriptor());
        bitmap = bitmap1;
_L3:
...
_L2:
        ...
        ImageManager.g(SV).post(new <init>(SV, mUri, bitmap, flag, countdownlatch));
        try
        {
