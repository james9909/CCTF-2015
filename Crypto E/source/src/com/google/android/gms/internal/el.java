...
public class el
{
    ...
    public Bundle b(String s, String s1, String s2)
    {
        Bundle bundle;
        try
        {
        ...
        {
            hf.d("IInAppBillingService is not available, please add com.android.vending.billing.IInAppBillingService to project.", exception);
            return null;
        }
        return bundle;
    }
    ...
    public void t(IBinder ibinder)
    {
        try
        {
            tv = mContext.getClassLoader().loadClass("com.android.vending.billing.IInAppBillingService$Stub").getDeclaredMethod("asInterface", new Class[] {
                android/os/IBinder
        ...
        {
            hf.X("IInAppBillingService is not available, please add com.android.vending.billing.IInAppBillingService to project.");
        }
    }
}
