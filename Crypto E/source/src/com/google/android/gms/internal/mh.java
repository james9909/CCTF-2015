...
public class mh extends j
{
    ...
    {
        return (AppVisibleCustomProperties)dataholder.jk().getSparseParcelableArray("customPropertiesExtra").get(i, AppVisibleCustomProperties.Yt);
    }
}
