    ...
    extends IInterface
{
        ...
        implements ez
    {
        ...
        public static ez x(IBinder ibinder)
        {
            if (ibinder == null)
            {
                return null;
            ...
            if (iinterface != null && (iinterface instanceof ez))
            {
                return (ez)iinterface;
            } else
            {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel1, int j)
        {
            ...
            case 1: // '\001'
                ...
                IBinder ibinder = c(com.google.android.gms.dynamic.d.a.aX(parcel.readStrongBinder()));
