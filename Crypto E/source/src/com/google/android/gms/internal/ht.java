    ...
    extends IInterface
{
        ...
        implements ht
    {
        ...
        public static ht D(IBinder ibinder)
        {
            if (ibinder == null)
            {
                return null;
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel1, int j)
        {
            ...
            case 1: // '\001'
                ...
                a(parcel.readHashMap(getClass().getClassLoader()), parcel.readLong(), parcel.readString(), parcel.createTypedArrayList(hs.CREATOR));
