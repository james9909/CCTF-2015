...
_L1:
    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel1, int j)
    {
        ...
        case 1: // '\001'
            ...
            a(F(parcel.readStrongBinder()), parcel.readString(), (ij[])parcel.createTypedArray(ij.CREATOR));
        ...
        case 4: // '\004'
            parcel.enforceInterface("com.google.android.gms.appdatasearch.internal.ILightweightAppDataSearch");
            io io = F(parcel.readStrongBinder());
            boolean flag;
            if (parcel.readInt() != 0)
            {
                flag = true;
        ...
        case 6: // '\006'
            parcel.enforceInterface("com.google.android.gms.appdatasearch.internal.ILightweightAppDataSearch");
            a(F(parcel.readStrongBinder()), parcel.createTypedArrayList(Uri.CREATOR));
            parcel1.writeNoException();
            return true;
        }
    }
