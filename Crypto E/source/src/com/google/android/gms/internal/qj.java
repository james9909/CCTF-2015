    ...
    implements android.os.Parcelable.Creator
{
    ...
    static void a(qb.f f, Parcel parcel, int i)
    {
        int j = b.am(parcel);
        Set set = f.avz;
        ...
        {
            b.a(parcel, 2, f.axb, true);
        }
        if (set.contains(Integer.valueOf(3)))
        {
            b.a(parcel, 3, f.acd, true);
        }
        if (set.contains(Integer.valueOf(4)))
        {
            b.a(parcel, 4, f.avW, true);
        }
        if (set.contains(Integer.valueOf(5)))
        {
            b.a(parcel, 5, f.axc, true);
        }
        ...
        {
            b.a(parcel, 8, f.awm, true);
        }
        if (set.contains(Integer.valueOf(9)))
        {
            b.a(parcel, 9, f.VX, true);
        }
    ...
    public qb.f ek(Parcel parcel)
    {
        ...
        do
        {
            ...
            } else
            {
                ...
                return new qb.f(hashset, k, s6, s5, s4, s3, s2, flag, s1, s, i);
            }
        } while (true);
    }

    public qb.f[] gK(int i)
    {
        return new qb.f[i];
    }
