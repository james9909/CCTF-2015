...
_L1:
        return;
_L2:
        if (!(obj instanceof rq)) goto _L4; else goto _L3
_L3:
        int i;
        Class class1;
        Method amethod[];
        ...
        if (s != null)
        {
            stringbuffer1.append(stringbuffer).append(ds(s)).append(" <\n");
            stringbuffer.append("  ");
        }
        class1 = obj.getClass();
...
_L4:
    ...
    private static String bo(String s)
    {
        int i = s.length();
    ...
    private static String ds(String s)
    {
    ...
    public static String g(rq rq1)
    {
        ...
        try
        {
            a(null, rq1, new StringBuffer(), stringbuffer);
        }
