    ...
    extends IInterface
{
        ...
        implements qy
    {
        ...
        public static qy cC(IBinder ibinder)
        {
            if (ibinder == null)
            {
                return null;
        ...
        public boolean onTransact(int j, Parcel parcel, Parcel parcel1, int k)
        {
            ...
            if (parcel.readInt() != 0)
            {
                qr1 = (qr)qr.CREATOR.createFromParcel(parcel);
            } else
            {
                qr1 = null;
            }
...
_L1:
        ...
        public void a(Status status, qr qr1, Bundle bundle)
        {
            Parcel parcel;
            Parcel parcel1;
            parcel = Parcel.obtain();
...
_L5:
            if (qr1 == null) goto _L4; else goto _L3
_L3:
            parcel.writeInt(1);
            qr1.writeToParcel(parcel, 0);
_L6:
            if (bundle == null)
            {
...
_L1:
    ...
    public abstract void a(Status status, qr qr, Bundle bundle);
