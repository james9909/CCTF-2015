...
//            GoogleAuthApiResponse, GoogleAuthApiResponseCreator
...
_L1:
    ...
    public abstract void onConnectionSuccess(GoogleAuthApiResponse googleauthapiresponse);

    public abstract void onError(int i, String s, PendingIntent pendingintent);
}
