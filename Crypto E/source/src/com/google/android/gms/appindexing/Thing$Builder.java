...
public static class 
{
    ...
    public EV put(String s1, Thing thing)
    {
        s.l(s1);
        if (thing != null)
        {
    ...
    public EV put(String s1, String s2)
    {
        s.l(s1);
        if (s2 != null)
        {
    ...
    public EV setDescription(String s1)
    {
        put("description", s1);
        return this;
    }

    public put setId(String s1)
    {
        if (s1 != null)
        {
            put("id", s1);
