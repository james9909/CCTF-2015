...
public final class AndroidAppUri
{
    ...
    {
        android.net.Uri.Builder builder = (new android.net.Uri.Builder()).scheme("android-app").authority(s);
        if (uri != null)
        {
            ...
            for (Iterator iterator = uri.getPathSegments().iterator(); iterator.hasNext(); builder.appendPath((String)iterator.next())) { }
