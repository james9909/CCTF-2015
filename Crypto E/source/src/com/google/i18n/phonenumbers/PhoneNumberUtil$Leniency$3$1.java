    ...
    implements pingChecker
{
    ...
    {
        return PhoneNumberMatcher.a(phonenumberutil, pingchecker, stringbuilder, as);
    }
    ...
    // Unreferenced inner class com/google/i18n/phonenumbers/PhoneNumberUtil$Leniency$3

/* anonymous class */
    static final class PhoneNumberUtil.Leniency._cls3 extends PhoneNumberUtil.Leniency
    {
        ...
        boolean a(Phonenumber.PhoneNumber phonenumber, String s, PhoneNumberUtil phonenumberutil)
        {
            ...
            {
                return PhoneNumberMatcher.a(phonenumber, s, phonenumberutil, new PhoneNumberUtil.Leniency._cls3._cls1(this));
            }
        }
