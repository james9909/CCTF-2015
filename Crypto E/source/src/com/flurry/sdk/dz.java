    ...
    implements dq.a, ey.a
{
    ...
    private dz()
    {
        ...
        el.a(4, c, (new StringBuilder()).append("initSettings, LocationCriteria = ").append(j).toString());
    ...
    private void j()
    {
        if (b && p == null)
        {
            ...
            if (context.checkCallingOrSelfPermission("android.permission.ACCESS_FINE_LOCATION") == 0 || context.checkCallingOrSelfPermission("android.permission.ACCESS_COARSE_LOCATION") == 0)
            {
                ...
                a(s);
                k = b(s);
                h = 0x15f90L + System.currentTimeMillis();
                l();
                a = true;
    ...
    private String k()
    {
        ...
        {
            s = i.getBestProvider(criteria, true);
        } else
        {
            s = m;
        }
        el.a(4, c, (new StringBuilder()).append("provider = ").append(s).toString());
        return s;
    }
    ...
    public void a(String s, Object obj)
    {
        ...
        {
            j = (Criteria)obj;
            el.a(4, c, (new StringBuilder()).append("onSettingUpdate, LocationCriteria = ").append(j).toString());
            if (a)
            {
                j();
            }
