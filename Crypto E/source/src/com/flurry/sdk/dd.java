    ...
    implements dq.a
{
    ...
    public void a(String s, Object obj)
    {
        ...
        if (s.equals("ReportUrl"))
        {
            ...
            b(s1);
            el.a(4, h, (new StringBuilder()).append("onSettingUpdate, ReportUrl = ").append(s1).toString());
            return;
        } else
        {
    ...
    protected void a(byte abyte0[], String s, String s1)
    {
        ...
        ei1.a(new ei.a(s, s1) {
            ...
            public void a(ei ei2, Void void1)
            {
                ...
                if (j > 0)
                {
                    el.d(dd.b(), (new StringBuilder()).append("FlurryDataSender: report ").append(a).append(" sent. HTTP response: ").append(j).toString());
                    if (el.c() <= 3 && el.d())
                    {
                        com.flurry.sdk.do.a().a(new Runnable(this, j) {
                            ...
                            public void run()
                            {
                                Toast.makeText(com.flurry.sdk.do.a().b(), (new StringBuilder()).append("SD HTTP Response Code: ").append(a).toString(), 0).show();
                            }
