...
class ow_edges extends EnumMap
{

    final ow_edges this$1;

    is._cls0(Class class1)
    {
        this$1 = this._cls1.this;
        super(class1);
        put(bute.NONE, Integer.valueOf(com.brightcove.player.n_no_edge_attribute));
        put(bute.UNIFORM, Integer.valueOf(com.brightcove.player.n_uniform_edges));
        put(bute.DEPRESSED, Integer.valueOf(com.brightcove.player.n_depressed_edges));
        put(bute.RAISED, Integer.valueOf(com.brightcove.player.n_raised_edges));
        put(bute.DROP_SHADOW, Integer.valueOf(com.brightcove.player.n_drop_shadow_edges));
    }
...
_L8:
        ...
        // Unreferenced inner class com/brightcove/player/captioning/BrightcoveClosedCaptioningOptionsDialog$1$1

/* anonymous class */
        class BrightcoveClosedCaptioningOptionsDialog._cls1._cls1 extends SparseArray
        {
