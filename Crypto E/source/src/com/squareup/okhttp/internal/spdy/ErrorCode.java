...
public final class ErrorCode extends Enum
{
    ...
    public static ErrorCode a(int i1)
    {
        ...
        int j1 = aerrorcode.length;
        for (int k1 = 0; k1 < j1; k1++)
        {
            ErrorCode errorcode = aerrorcode[k1];
            if (errorcode.t == i1)
            {
                return errorcode;
            }
    ...
    {
        return (ErrorCode)Enum.valueOf(com/squareup/okhttp/internal/spdy/ErrorCode, s1);
    }
    ...
    static 
    {
        ...
        ErrorCode aerrorcode[] = new ErrorCode[18];
        aerrorcode[0] = a;
        aerrorcode[1] = b;
        aerrorcode[2] = c;
        aerrorcode[3] = d;
