...
public final class CopticChronology extends BasicFixedMonthChronology
{
    ...
    private static final CopticChronology c;
    ...
    public static CopticChronology a(DateTimeZone datetimezone, int i)
    {
        ...
        CopticChronology acopticchronology[] = (CopticChronology[])b.get(datetimezone);
        if (acopticchronology != null)
        {
            break MISSING_BLOCK_LABEL_52;
        }
        acopticchronology = new CopticChronology[7];
        b.put(datetimezone, acopticchronology);
        CopticChronology acopticchronology1[];
        int j;
        acopticchronology1 = acopticchronology;
        j = i - 1;
        CopticChronology copticchronology = acopticchronology1[j];
        if (copticchronology != null) goto _L2; else goto _L1
_L1:
        if (datetimezone != DateTimeZone.a)
        {
            break MISSING_BLOCK_LABEL_172;
        }
        CopticChronology copticchronology1 = new CopticChronology(null, null, i);
        copticchronology = new CopticChronology(LimitChronology.a(copticchronology1, new DateTime(1, 1, 1, 0, 0, 0, 0, copticchronology1), null), null, i);
_L3:
        acopticchronology1[i - 1] = copticchronology;
_L2:
        map;
