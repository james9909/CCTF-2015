...
.method private invokeListenersForEventType(Lcom/brightcove/player/event/Event;Ljava/lang/String;)V
    ...
    invoke-interface {v1, p1}, Lcom/brightcove/player/event/EventListener;->processEvent(Lcom/brightcove/player/event/Event;)V
    :try_end_0
    ...
    .line 435
    iget-object v4, p0, Lcom/brightcove/player/event/EventEmitterImpl;->TAG:Ljava/lang/String;

    const-string v5, "processEvent() threw a throwable."
...
.method private on(Ljava/lang/String;Lcom/brightcove/player/event/EventListener;Z)I
    ...
    const-string v2, "Invalid input provided to on: evenType = "
...
.method private unpackProperties(Ljava/util/Map;Lcom/brightcove/player/event/Event;)V
    ...
    .line 313
    iget-object v3, p2, Lcom/brightcove/player/event/Event;->properties:Ljava/util/Map;
...
.method public emit(Ljava/lang/String;Ljava/util/Map;)V
    ...
    const-string v1, "Received an emit without an EventType"
...
.method public off(Ljava/lang/String;I)V
    ...
    const-string v2, "Off attempted for invalid token of "
...
.method public respond(Ljava/util/Map;)V
    ...
    const-string v1, "Respond attempted without an requestToken"
