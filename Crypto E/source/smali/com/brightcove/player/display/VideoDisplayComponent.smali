...
# static fields
.field private static final EXECUTOR:Ljava/util/concurrent/ScheduledExecutorService; = null
...
.method private createPlayer(Lcom/brightcove/player/model/Video;Lcom/brightcove/player/model/Source;)V
    ...
    const-string v2, "IOException trying to play video"
    ...
    const-string v1, "Headers ignored below API level 14"
...
.method protected static getHeaders(Lcom/brightcove/player/model/Video;Lcom/brightcove/player/model/Source;)Ljava/util/Map;
    ...
    const-string v3, "Failed to use Video headers."
    ...
    const-string v3, "Failed to use Source headers."
...
.method private play(I)V
    ...
    const-string v2, ", seekPositionWhenPrepared = "
...
.method protected destroyPlayer()V
    ...
    const-string v1, "Shutting down current MediaPlayer"
...
.method protected emitVideoSize(II)V
    ...
    invoke-interface {v2}, Lcom/brightcove/player/view/RenderView;->getWidth()I
...
.method protected openVideo(Lcom/brightcove/player/model/Video;Lcom/brightcove/player/model/Source;)V
    ...
    const-string v3, "openVideo: surface = "
    ...
    iget-boolean v3, p0, Lcom/brightcove/player/display/VideoDisplayComponent;->hasSurface:Z
