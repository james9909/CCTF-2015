...
.method public synthetic freeze()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/internal/qm;->rh()Lcom/google/android/gms/plus/model/people/Person;
...
.method public getDisplayName()Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/gms/internal/qm;->getString(Ljava/lang/String;)Ljava/lang/String;
...
.method public getImage()Lcom/google/android/gms/plus/model/people/Person$Image;
    ...
    new-instance v0, Lcom/google/android/gms/internal/qb$c;

    const-string v1, "image"

    invoke-virtual {p0, v1}, Lcom/google/android/gms/internal/qm;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    invoke-direct {v0, v1}, Lcom/google/android/gms/internal/qb$c;-><init>(Ljava/lang/String;)V
...
.method public getObjectType()I
    ...
    invoke-static {v0}, Lcom/google/android/gms/internal/qb$e;->cr(Ljava/lang/String;)I
...
.method public synthetic getOrganizations()Ljava/util/List;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/internal/qm;->re()Ljava/util/ArrayList;
...
.method public synthetic getPlacesLived()Ljava/util/List;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/internal/qm;->rf()Ljava/util/ArrayList;
...
.method public synthetic getUrls()Ljava/util/List;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/internal/qm;->rg()Ljava/util/ArrayList;
...
.method public re()Ljava/util/ArrayList;
    .locals 1
...
.method public rg()Ljava/util/ArrayList;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public rh()Lcom/google/android/gms/plus/model/people/Person;
    .locals 6

    new-instance v0, Lcom/google/android/gms/internal/qb;

    invoke-virtual {p0}, Lcom/google/android/gms/internal/qm;->getDisplayName()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p0}, Lcom/google/android/gms/internal/qm;->getId()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {p0}, Lcom/google/android/gms/internal/qm;->getImage()Lcom/google/android/gms/plus/model/people/Person$Image;

    move-result-object v3

    check-cast v3, Lcom/google/android/gms/internal/qb$c;

    invoke-virtual {p0}, Lcom/google/android/gms/internal/qm;->getObjectType()I

    move-result v4

    invoke-virtual {p0}, Lcom/google/android/gms/internal/qm;->getUrl()Ljava/lang/String;

    move-result-object v5

    invoke-direct/range {v0 .. v5}, Lcom/google/android/gms/internal/qb;-><init>(Ljava/lang/String;Ljava/lang/String;Lcom/google/android/gms/internal/qb$c;ILjava/lang/String;)V
