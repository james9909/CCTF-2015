...
.method public static a(Ljava/lang/String;Landroid/net/Uri;)Landroid/content/Intent;
    ...
    invoke-static {p0, p1}, Lcom/google/android/gms/internal/is;->b(Ljava/lang/String;Landroid/net/Uri;)V
...
.method public static c(Ljava/util/List;)V
    ...
    invoke-static {v2, v0}, Lcom/google/android/gms/internal/is;->b(Ljava/lang/String;Landroid/net/Uri;)V
...
# virtual methods
.method public varargs a(Lcom/google/android/gms/common/api/GoogleApiClient;[Lcom/google/android/gms/internal/ij;)Lcom/google/android/gms/common/api/PendingResult;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p0, p1, v0, p2}, Lcom/google/android/gms/internal/is$1;-><init>(Lcom/google/android/gms/internal/is;Lcom/google/android/gms/common/api/GoogleApiClient;Ljava/lang/String;[Lcom/google/android/gms/internal/ij;)V
...
.method public action(Lcom/google/android/gms/common/api/GoogleApiClient;Lcom/google/android/gms/appindexing/Action;)Lcom/google/android/gms/appindexing/AppIndexApi$ActionResult;
    ...
    new-array v6, v0, [Lcom/google/android/gms/internal/ij;
    ...
    invoke-virtual {p0, p1, v6}, Lcom/google/android/gms/internal/is;->a(Lcom/google/android/gms/common/api/GoogleApiClient;[Lcom/google/android/gms/internal/ij;)Lcom/google/android/gms/common/api/PendingResult;

    move-result-object v0

    new-instance v2, Lcom/google/android/gms/internal/is$a;

    invoke-direct {v2, p0, v0, p2, v1}, Lcom/google/android/gms/internal/is$a;-><init>(Lcom/google/android/gms/internal/is;Lcom/google/android/gms/common/api/PendingResult;Lcom/google/android/gms/appindexing/Action;Ljava/lang/String;)V
...
.method public view(Lcom/google/android/gms/common/api/GoogleApiClient;Landroid/app/Activity;Landroid/content/Intent;Ljava/lang/String;Landroid/net/Uri;Ljava/util/List;)Lcom/google/android/gms/common/api/PendingResult;
    ...
    invoke-static {p6}, Lcom/google/android/gms/internal/is;->c(Ljava/util/List;)V

    const/4 v0, 0x1

    new-array v7, v0, [Lcom/google/android/gms/internal/ij;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/google/android/gms/internal/ij;-><init>(Ljava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/net/Uri;Ljava/lang/String;Ljava/util/List;)V

    aput-object v0, v7, v8

    invoke-virtual {p0, p1, v7}, Lcom/google/android/gms/internal/is;->a(Lcom/google/android/gms/common/api/GoogleApiClient;[Lcom/google/android/gms/internal/ij;)Lcom/google/android/gms/common/api/PendingResult;
...
.method public view(Lcom/google/android/gms/common/api/GoogleApiClient;Landroid/app/Activity;Landroid/net/Uri;Ljava/lang/String;Landroid/net/Uri;Ljava/util/List;)Lcom/google/android/gms/common/api/PendingResult;
    ...
    invoke-static {v0, p3}, Lcom/google/android/gms/internal/is;->b(Ljava/lang/String;Landroid/net/Uri;)V

    invoke-static {v0, p3}, Lcom/google/android/gms/internal/is;->a(Ljava/lang/String;Landroid/net/Uri;)Landroid/content/Intent;
    ...
    invoke-virtual/range {v0 .. v6}, Lcom/google/android/gms/internal/is;->view(Lcom/google/android/gms/common/api/GoogleApiClient;Landroid/app/Activity;Landroid/content/Intent;Ljava/lang/String;Landroid/net/Uri;Ljava/util/List;)Lcom/google/android/gms/common/api/PendingResult;
...
.method public viewEnd(Lcom/google/android/gms/common/api/GoogleApiClient;Landroid/app/Activity;Landroid/content/Intent;)Lcom/google/android/gms/common/api/PendingResult;
    ...
    invoke-static {v0, p3}, Lcom/google/android/gms/internal/ij;->a(Ljava/lang/String;Landroid/content/Intent;)Lcom/google/android/gms/internal/hx;
    ...
    invoke-direct {v1, v0, v2, v3, v4}, Lcom/google/android/gms/internal/ij;-><init>(Lcom/google/android/gms/internal/hx;JI)V

    const/4 v0, 0x1

    new-array v0, v0, [Lcom/google/android/gms/internal/ij;

    const/4 v2, 0x0

    aput-object v1, v0, v2

    invoke-virtual {p0, p1, v0}, Lcom/google/android/gms/internal/is;->a(Lcom/google/android/gms/common/api/GoogleApiClient;[Lcom/google/android/gms/internal/ij;)Lcom/google/android/gms/common/api/PendingResult;
...
.method public viewEnd(Lcom/google/android/gms/common/api/GoogleApiClient;Landroid/app/Activity;Landroid/net/Uri;)Lcom/google/android/gms/common/api/PendingResult;
    ...
    invoke-virtual {p0, p1, p2, v0}, Lcom/google/android/gms/internal/is;->viewEnd(Lcom/google/android/gms/common/api/GoogleApiClient;Landroid/app/Activity;Landroid/content/Intent;)Lcom/google/android/gms/common/api/PendingResult;
