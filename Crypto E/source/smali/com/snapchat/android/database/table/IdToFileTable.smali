...
.method protected bridge synthetic a(Ljava/lang/Object;)Landroid/content/ContentValues;
    ...
    invoke-virtual {p0, p1}, Lcom/snapchat/android/database/table/IdToFileTable;->a(Ljava/util/Map$Entry;)Landroid/content/ContentValues;
...
.method protected a(Ljava/util/Map$Entry;)Landroid/content/ContentValues;
    .locals 3
    .parameter
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    .line 80
    sget-object v2, Lcom/snapchat/android/database/table/IdToFileTable$IdToFileSchema;->a:Lcom/snapchat/android/database/table/IdToFileTable$IdToFileSchema;
    ...
    .line 81
    sget-object v2, Lcom/snapchat/android/database/table/IdToFileTable$IdToFileSchema;->b:Lcom/snapchat/android/database/table/IdToFileTable$IdToFileSchema;
...
.method protected a(Landroid/database/Cursor;)Ljava/util/Map$Entry;
    .locals 1
    .parameter
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method protected synthetic b(Landroid/database/Cursor;)Ljava/lang/Object;
    ...
    .prologue
    .line 23
    invoke-virtual {p0, p1}, Lcom/snapchat/android/database/table/IdToFileTable;->a(Landroid/database/Cursor;)Ljava/util/Map$Entry;
...
.method protected f()Ljava/util/Map;
    ...
    .line 28
    invoke-virtual {p0}, Lcom/snapchat/android/database/table/IdToFileTable;->j()Ljava/util/concurrent/locks/Lock;
    ...
    .line 29
    iget-object v0, p0, Lcom/snapchat/android/database/table/IdToFileTable;->d:Landroid/database/sqlite/SQLiteDatabase;

    invoke-virtual {p0}, Lcom/snapchat/android/database/table/IdToFileTable;->a()Ljava/lang/String;
    ...
    .line 31
    :try_start_0
    invoke-virtual {p0}, Lcom/snapchat/android/database/table/IdToFileTable;->o()Landroid/database/sqlite/SQLiteDatabase;
    :try_end_0
    ...
    .line 40
    sget-object v0, Lcom/snapchat/android/database/table/IdToFileTable$IdToFileSchema;->a:Lcom/snapchat/android/database/table/IdToFileTable$IdToFileSchema;

    invoke-virtual {v0}, Lcom/snapchat/android/database/table/IdToFileTable$IdToFileSchema;->b()I
    ...
    sget-object v3, Lcom/snapchat/android/database/table/IdToFileTable$IdToFileSchema;->b:Lcom/snapchat/android/database/table/IdToFileTable$IdToFileSchema;

    invoke-virtual {v3}, Lcom/snapchat/android/database/table/IdToFileTable$IdToFileSchema;->b()I
