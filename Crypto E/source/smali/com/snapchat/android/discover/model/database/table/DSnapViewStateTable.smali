.class public Lcom/snapchat/android/discover/model/database/table/DSnapViewStateTable;
...
.field private static final e:Lcom/snapchat/android/discover/model/database/table/DSnapViewStateTable;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/snapchat/android/discover/model/database/table/DSnapViewStateTable;->e:Lcom/snapchat/android/discover/model/database/table/DSnapViewStateTable;
    ...
    invoke-virtual {v5}, Lcom/snapchat/android/discover/model/database/table/DSnapViewStateTable$DSnapViewStateSchema;->c()Ljava/lang/String;
    ...
    invoke-virtual {v3}, Lcom/snapchat/android/discover/model/database/table/DSnapViewStateTable$DSnapViewStateSchema;->c()Ljava/lang/String;
...
.method protected constructor <init>()V
    ...
    invoke-direct {p0, v0}, Lcom/snapchat/android/discover/model/database/table/DSnapViewStateTable;-><init>(Lcom/snapchat/android/discover/model/DiscoverViewTrackingManager;)V
...
.method private constructor <init>(Lcom/snapchat/android/discover/model/DiscoverViewTrackingManager;)V
    ...
    .line 48
    iput-object p1, p0, Lcom/snapchat/android/discover/model/database/table/DSnapViewStateTable;->f:Lcom/snapchat/android/discover/model/DiscoverViewTrackingManager;

    .line 49
    return-void
.end method

.method public static b()Lcom/snapchat/android/discover/model/database/table/DSnapViewStateTable;
    .locals 1

    .prologue
    .line 98
    sget-object v0, Lcom/snapchat/android/discover/model/database/table/DSnapViewStateTable;->e:Lcom/snapchat/android/discover/model/database/table/DSnapViewStateTable;
...
# virtual methods
.method protected a(Lcom/snapchat/android/discover/model/DiscoverViewTrackingManager$DSnapViewState;)Landroid/content/ContentValues;
    .locals 4
    .parameter
    ...
    invoke-virtual {p1}, Lcom/snapchat/android/discover/model/DiscoverViewTrackingManager$DSnapViewState;->a()Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lcom/snapchat/android/discover/model/DiscoverViewTrackingManager$DSnapViewState;->b()J
...
.method protected bridge synthetic a(Ljava/lang/Object;)Landroid/content/ContentValues;
    ...
    .prologue
    .line 32
    check-cast p1, Lcom/snapchat/android/discover/model/DiscoverViewTrackingManager$DSnapViewState;

    invoke-virtual {p0, p1}, Lcom/snapchat/android/discover/model/database/table/DSnapViewStateTable;->a(Lcom/snapchat/android/discover/model/DiscoverViewTrackingManager$DSnapViewState;)Landroid/content/ContentValues;
...
.method protected a(Landroid/database/Cursor;)Lcom/snapchat/android/discover/model/DiscoverViewTrackingManager$DSnapViewState;
    .locals 4
    .parameter

    .prologue
    .line 230
    sget-object v0, Lcom/snapchat/android/discover/model/database/table/DSnapViewStateTable$DSnapViewStateSchema;->a:Lcom/snapchat/android/discover/model/database/table/DSnapViewStateTable$DSnapViewStateSchema;

    invoke-virtual {v0}, Lcom/snapchat/android/discover/model/database/table/DSnapViewStateTable$DSnapViewStateSchema;->b()I
    ...
    invoke-virtual {v1}, Lcom/snapchat/android/discover/model/database/table/DSnapViewStateTable$DSnapViewStateSchema;->b()I
    ...
    invoke-direct {v1, v0, v2, v3}, Lcom/snapchat/android/discover/model/DiscoverViewTrackingManager$DSnapViewState;-><init>(Ljava/lang/String;J)V
...
.method public a(Landroid/content/Context;)V
    ...
    .line 167
    iget-object v0, p0, Lcom/snapchat/android/discover/model/database/table/DSnapViewStateTable;->f:Lcom/snapchat/android/discover/model/DiscoverViewTrackingManager;

    invoke-virtual {v0}, Lcom/snapchat/android/discover/model/DiscoverViewTrackingManager;->d()Ljava/util/Collection;
    ...
    .line 169
    invoke-virtual {p0, v1, v0}, Lcom/snapchat/android/discover/model/database/table/DSnapViewStateTable;->a(Landroid/database/sqlite/SQLiteDatabase;Lcom/snapchat/android/discover/model/DiscoverViewTrackingManager$DSnapViewState;)V
    :try_end_0
    ...
    sget-object v2, Lcom/snapchat/android/discover/model/database/table/DSnapViewStateTable$DSnapViewStateSchema;->a:Lcom/snapchat/android/discover/model/database/table/DSnapViewStateTable$DSnapViewStateSchema;

    const-string v3, "EditionChunk"

    sget-object v4, Lcom/snapchat/android/discover/model/database/table/EditionChunkTable$EditionChunkSchema;->a:Lcom/snapchat/android/discover/model/database/table/EditionChunkTable$EditionChunkSchema;
...
.method public a(Landroid/database/sqlite/SQLiteDatabase;Lcom/snapchat/android/discover/model/DiscoverViewTrackingManager$DSnapViewState;)V
    .locals 4
    .parameter
    .end parameter
    .parameter
    ...
    .prologue
    .line 185
    invoke-virtual {p0, p2}, Lcom/snapchat/android/discover/model/database/table/DSnapViewStateTable;->a(Lcom/snapchat/android/discover/model/DiscoverViewTrackingManager$DSnapViewState;)Landroid/content/ContentValues;
    ...
    const-string v1, "Insertion in DB failed for DSnapViewState"
...
.method public a(Lcom/snapchat/android/model/User;)V
    ...
    .line 144
    :try_start_0
    invoke-virtual {p0, v1}, Lcom/snapchat/android/discover/model/database/table/DSnapViewStateTable;->b(Landroid/database/sqlite/SQLiteDatabase;)Ljava/util/List;

    move-result-object v0

    .line 146
    iget-object v2, p0, Lcom/snapchat/android/discover/model/database/table/DSnapViewStateTable;->f:Lcom/snapchat/android/discover/model/DiscoverViewTrackingManager;

    invoke-virtual {v2, v0}, Lcom/snapchat/android/discover/model/DiscoverViewTrackingManager;->c(Ljava/util/List;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method protected b(Landroid/database/sqlite/SQLiteDatabase;)Ljava/util/List;
    ...
    .line 217
    :cond_0
    invoke-virtual {p0, v1}, Lcom/snapchat/android/discover/model/database/table/DSnapViewStateTable;->a(Landroid/database/Cursor;)Lcom/snapchat/android/discover/model/DiscoverViewTrackingManager$DSnapViewState;
...
.method public c()Ljava/lang/String;
    ...
    .line 117
    invoke-virtual {v4}, Lcom/snapchat/android/discover/model/database/table/DSnapViewStateTable$DSnapViewStateSchema;->d()Ljava/lang/String;
