...
.method private processFrame([B)V
    ...
    .line 425
    iput v7, p0, Lcom/addlive/impl/cam/ADLCameraHelper;->prevOrientation:I

    .line 427
    :cond_1
    iget-object v1, p0, Lcom/addlive/impl/cam/ADLCameraHelper;->frameReceiver:Lcom/addlive/impl/cb/ADLInjectFrameCb;

    iget v3, p0, Lcom/addlive/impl/cam/ADLCameraHelper;->width:I

    iget v4, p0, Lcom/addlive/impl/cam/ADLCameraHelper;->height:I
    ...
    invoke-interface/range {v1 .. v9}, Lcom/addlive/impl/cb/ADLInjectFrameCb;->injectFrame([BIIIIIJ)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getFrameRateRange(Ljava/util/List;I)[I
    ...
    const-string v4, "The camera does not support framerate as low as the requested one. Will use the lowest framerate range possible: ["
    ...
    const-string v4, "Will use FPS range: ["
