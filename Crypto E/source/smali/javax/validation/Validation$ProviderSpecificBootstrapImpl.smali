.class Ljavax/validation/Validation$ProviderSpecificBootstrapImpl;
...
# virtual methods
.method public configure()Ljavax/validation/Configuration;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()TT;"
    ...
    .line 200
    :cond_0
    new-instance v1, Ljavax/validation/Validation$GenericBootstrapImpl;

    const/4 v0, 0x0

    invoke-direct {v1, v0}, Ljavax/validation/Validation$GenericBootstrapImpl;-><init>(Ljavax/validation/Validation$1;)V
    ...
    .line 202
    invoke-virtual {v1}, Ljavax/validation/Validation$GenericBootstrapImpl;->getDefaultValidationProviderResolver()Ljavax/validation/ValidationProviderResolver;
    ...
    .line 218
    iget-object v3, p0, Ljavax/validation/Validation$ProviderSpecificBootstrapImpl;->validationProviderClass:Ljava/lang/Class;
    ...
    .line 220
    invoke-interface {v0, v1}, Ljavax/validation/spi/ValidationProvider;->createSpecializedConfiguration(Ljavax/validation/spi/BootstrapState;)Ljavax/validation/Configuration;
    ...
    invoke-virtual {v1, v0}, Ljavax/validation/Validation$GenericBootstrapImpl;->providerResolver(Ljavax/validation/ValidationProviderResolver;)Ljavax/validation/bootstrap/GenericBootstrap;
...
.method public providerResolver(Ljavax/validation/ValidationProviderResolver;)Ljavax/validation/bootstrap/ProviderSpecificBootstrap;
    .locals 0
    .parameter
    .annotation system Ldalvik/annotation/Signature;
        value = {
