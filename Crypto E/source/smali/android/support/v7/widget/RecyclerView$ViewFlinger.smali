...
.method public run()V
    ...
    iget-object v3, v0, Landroid/support/v7/widget/RecyclerView$ViewFlinger;->a:Landroid/support/v7/widget/RecyclerView;
    ...
    iget-object v11, v0, Landroid/support/v7/widget/RecyclerView$ViewFlinger;->d:Landroid/support/v4/widget/ScrollerCompat;
    ...
    iget-object v12, v3, Landroid/support/v7/widget/RecyclerView$LayoutManager;->r:Landroid/support/v7/widget/RecyclerView$SmoothScroller;
    ...
    iget v3, v0, Landroid/support/v7/widget/RecyclerView$ViewFlinger;->b:I
    ...
    iget v3, v0, Landroid/support/v7/widget/RecyclerView$ViewFlinger;->c:I
    ...
    iput v13, v0, Landroid/support/v7/widget/RecyclerView$ViewFlinger;->b:I

    .line 2787
    move-object/from16 v0, p0

    iput v14, v0, Landroid/support/v7/widget/RecyclerView$ViewFlinger;->c:I
    ...
    invoke-static {v7}, Landroid/support/v7/widget/RecyclerView;->f(Landroid/support/v7/widget/RecyclerView;)Landroid/support/v7/widget/RecyclerView$Adapter;
    ...
    invoke-static {v5}, Landroid/support/v7/widget/RecyclerView;->d(Landroid/support/v7/widget/RecyclerView;)Landroid/support/v7/widget/RecyclerView$LayoutManager;
    ...
    iget-object v6, v6, Landroid/support/v7/widget/RecyclerView;->a:Landroid/support/v7/widget/RecyclerView$Recycler;

    move-object/from16 v0, p0

    iget-object v7, v0, Landroid/support/v7/widget/RecyclerView$ViewFlinger;->a:Landroid/support/v7/widget/RecyclerView;

    iget-object v7, v7, Landroid/support/v7/widget/RecyclerView;->f:Landroid/support/v7/widget/RecyclerView$State;

    invoke-virtual {v5, v15, v6, v7}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->a(ILandroid/support/v7/widget/RecyclerView$Recycler;Landroid/support/v7/widget/RecyclerView$State;)I
    ...
    iget-object v4, v4, Landroid/support/v7/widget/RecyclerView;->a:Landroid/support/v7/widget/RecyclerView$Recycler;
    ...
    invoke-virtual {v3, v0, v4, v7}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->b(ILandroid/support/v7/widget/RecyclerView$Recycler;Landroid/support/v7/widget/RecyclerView$State;)I
    ...
    iget-object v7, v7, Landroid/support/v7/widget/RecyclerView;->c:Landroid/support/v7/widget/ChildHelper;

    invoke-virtual {v7}, Landroid/support/v7/widget/ChildHelper;->b()I
    ...
    invoke-virtual {v7, v8}, Landroid/support/v7/widget/ChildHelper;->b(I)Landroid/view/View;
    ...
    invoke-virtual {v7, v10}, Landroid/support/v7/widget/RecyclerView;->a(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    iget-object v0, v7, Landroid/support/v7/widget/RecyclerView$ViewHolder;->h:Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    iget-object v7, v7, Landroid/support/v7/widget/RecyclerView$ViewHolder;->h:Landroid/support/v7/widget/RecyclerView$ViewHolder;

    iget-object v7, v7, Landroid/support/v7/widget/RecyclerView$ViewHolder;->a:Landroid/view/View;
    ...
    invoke-virtual {v12}, Landroid/support/v7/widget/RecyclerView$SmoothScroller;->f()Z

    move-result v7

    if-nez v7, :cond_6

    invoke-virtual {v12}, Landroid/support/v7/widget/RecyclerView$SmoothScroller;->g()Z
    ...
    invoke-virtual {v7}, Landroid/support/v7/widget/RecyclerView$State;->e()I
    ...
    .line 2827
    invoke-virtual {v12}, Landroid/support/v7/widget/RecyclerView$SmoothScroller;->e()V
    ...
    invoke-static {v4}, Landroid/support/v7/widget/RecyclerView;->i(Landroid/support/v7/widget/RecyclerView;)Landroid/support/v7/widget/RecyclerView$OnScrollListener;
    ...
    invoke-virtual {v4, v5, v10, v9}, Landroid/support/v7/widget/RecyclerView$OnScrollListener;->a(Landroid/support/v7/widget/RecyclerView;II)V
    ...
    invoke-static {v12, v3, v4}, Landroid/support/v7/widget/RecyclerView$SmoothScroller;->a(Landroid/support/v7/widget/RecyclerView$SmoothScroller;II)V
    ...
    .line 2828
    :cond_16
    invoke-virtual {v12}, Landroid/support/v7/widget/RecyclerView$SmoothScroller;->h()I
    ...
    invoke-virtual {v12, v7}, Landroid/support/v7/widget/RecyclerView$SmoothScroller;->d(I)V
    ...
    invoke-static {v12, v7, v8}, Landroid/support/v7/widget/RecyclerView$SmoothScroller;->a(Landroid/support/v7/widget/RecyclerView$SmoothScroller;II)V
